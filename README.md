...
##  Features
1. **Debloat:** Removes pre-installed junk (Candy Crush, Xbox, etc.) for all users.
2. **Sanitize:** Disables "Consumer Experiences" to prevent new junk from auto-installing.
3. **Automate:** Installs Chocolatey and a list of essential apps silently.
